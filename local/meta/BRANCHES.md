...
| 20 | `local/auth-overlay` | local | `release-base` | SQL users, Telegram authentication, migration, administration, delegated group managers, and self-service features | M5 ready |
...
| `feat/password-self-service` | `local/auth-overlay` | User profile and password self-service with fresh Telegram proof, plus delegated group managers | Complete |

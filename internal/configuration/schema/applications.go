...
type Application struct {
	...
	Domain  string `koanf:"domain" yaml:"domain" toml:"domain" json:"domain" jsonschema:"required,title=Domain" jsonschema_description:"The application domain shown in the administrative UI."`

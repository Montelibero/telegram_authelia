...
type Configuration struct {
	...
	Applications          []Application         `koanf:"applications" yaml:"applications,omitempty" toml:"applications,omitempty" json:"applications,omitempty" jsonschema:"title=Applications" jsonschema_description:"Applications exposed for administrative permission management."`
	Telegram              Telegram              `koanf:"telegram" yaml:"telegram,omitempty" toml:"telegram,omitempty" json:"telegram,omitempty" jsonschema:"title=Telegram" jsonschema_description:"Telegram Login Configuration."`

...
type IdentityValidationElevatedSession struct {
	...
	DisableOneTimeCode  bool          `koanf:"disable_one_time_code" yaml:"disable_one_time_code" toml:"disable_one_time_code" json:"disable_one_time_code" jsonschema:"title=Disable One-Time Code,default=false" jsonschema_description:"Disables email One-Time Codes for session elevation and allows a recent successful authentication to satisfy ordinary elevation checks."`
